...
-   [The Silent Lock Spikes: Non-Invasive MySQL Observability Without Downtime or Alert Fatigue] (case-studies/13-The Silent Lock Spikes: Non-Invasive MySQL Observability Without Downtime or Alert Fatigue.md) — how uncommitted application transaction leaks (`idle_in_trx`) silently locked rows without executing active queries, and how I engineered a zero-overhead metadata watchdog with lock-tree dependency filtering to eliminate alert spam and auto-generate post-mortems.
